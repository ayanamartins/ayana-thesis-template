...
%\draw[fill=white,opacity=1] (1cm,0) rectangle (8cm,-7cm);
%\node[anchor=north west] at (1cm,.25cm) {\parbox[t][8cm][t]{6.5cm}{\huge\bfseries\flushleft \printcontents{l}{1}{\setcounter{tocdepth}{2}}}};
\draw[anchor=west] (-0.2cm,-2.5cm) node [fill=white,fill opacity=1,text opacity=1,draw=color,draw opacity=1,line width=2pt,inner sep=15pt]{\huge\sffamily\bfseries\textcolor{black}{  \ #1\vphantom{plPQq}\makebox[22cm]{}}};
\end{tikzpicture}};
